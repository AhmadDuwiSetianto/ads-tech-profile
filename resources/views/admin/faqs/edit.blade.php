        ...
        <div class="bg-white rounded-3xl shadow-sm border border-slate-100 p-8 sm:p-10">
            <form action="{{ route('admin.faqs.update', $faq) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="question" value="{{ old('question', $faq->question) }}" class="w-full rounded-xl border-slate-200 bg-slate-50 px-4 py-3 text-sm focus:bg-white focus:border-brand-blue focus:ring-4 focus:ring-brand-blue/10 transition-all outline-none" required>
                ...
                <div class="mb-8">
                    ...
                    <textarea name="answer" rows="5" class="w-full rounded-xl border-slate-200 bg-slate-50 px-4 py-3 text-sm focus:bg-white focus:border-brand-blue focus:ring-4 focus:ring-brand-blue/10 transition-all outline-none resize-y" required>{{ old('answer', $faq->answer) }}</textarea>
                ...
                <div class="flex justify-end gap-3 pt-6 border-t border-slate-100">
                    ...
                    <button type="submit" class="inline-flex items-center justify-center px-8 py-3 rounded-full text-sm font-bold bg-brand-blue text-white shadow-md hover:bg-brand-blue-hover focus:ring-4 focus:ring-brand-blue/20 transition-all">Update FAQ</button>
                </div>
            </form>
        </div>
    </div>
