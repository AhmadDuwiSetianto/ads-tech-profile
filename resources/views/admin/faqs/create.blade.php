<x-admin-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">Tambah FAQ</h2>
    </x-slot>
            ...
            <div class="bg-white p-6 rounded-lg shadow-sm">
                <form action="{{ route('admin.faqs.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="question" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500" required>
                    </div>
                    <div class="mb-6">
                        <label class="block text-sm font-medium text-gray-700">Jawaban</label>
                        <textarea name="answer" rows="4" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500" required></textarea>
                    </div>
